...
export const TRANSLATIONS: Record<string, { en: string; hi: string }> = {
  ...
  "footer.copyright": { en: "© 2026 किसानSetu Technologies Private Limited. All rights reserved.", hi: "© 2026 किसानSetu टेक्नोलॉजीज प्राइवेट लिमिटेड। सर्वाधिकार सुरक्षित।" },
